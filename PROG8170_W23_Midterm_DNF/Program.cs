...
namespace PROG8170_W23_Midterm_DNF
{
            ...
            while (true)
            {
                ...
                switch (menuoption)
                {
                    ...
                    case 4:
                        ...
                        Console.WriteLine("Rectangle's width is set to " + rect.SetWidth(width) + " ");
                        break;
                    case 5:
                        Console.WriteLine("Rectangle's Perimeter is " + rect.GetPerimeter() + " ");
                        break;
                    case 6:
                        Console.WriteLine("Rectangle's Area is " + rect.GetArea() + " square");
                        break;
                    case 7:
                        return;
                    default:
